...
`;
  ...
  async buildResponse(data) {
    ...
    const headers = new import_node_fetch.Headers(headersInit);
    return (0, import_node_fetch.default)(`${this.PRIMARY_DOMAIN + this.URL}`, {
...
WechatService = __decorateClass([
  ...
  __decorateParam(0, (0, import_common.Inject)("WECHAT_OPTIONS"))
], WechatService);
